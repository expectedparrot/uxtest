...
After running a synthetic task discovery study, export screenshots into an EDSL
human survey when you want real respondents to validate interpretation or first
click intent:
